...
namespace SearchingAlgorithms
{
        ...
        where TState : Heuristical<TState>, Generative<TState>
    {
        ...
        public AStarOld(TState generator, int heapSize = DEFAULT_HEAP_SIZE, int hashSize = DEFAULT_HASH_SIZE, int hashMaxElementsCount = DEFAULT_HASH_MAX_ELEMENTS, int maxSearchingDepth = -1, int maxSearchingTime = -1)
        {
